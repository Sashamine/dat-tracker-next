...
export default function AssetPage() {
  ...
  const companies = useMemo(
    () => applyD1Overlay(enrichedCompanies, d1Data, d1Sources, d1Dates, d1Quotes, d1SearchTerms, d1Accessions),
    [enrichedCompanies, d1Data, d1Sources, d1Dates, d1Quotes, d1SearchTerms, d1Accessions]
  );
