...
function HomeContent() {
  ...
  const d1Companies = useMemo(
    () => applyD1Overlay(companies, d1Data, d1Sources, d1Dates, d1Quotes, d1SearchTerms, d1Accessions),
    [companies, d1Data, d1Sources, d1Dates, d1Quotes, d1SearchTerms, d1Accessions]
  );
      ...
      <main className="flex-1 lg:ml-64">
        <div className="px-3 py-4 lg:px-4 lg:py-6 max-w-full">
          ...
          <footer className="mt-8 text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <p className="text-xs text-gray-400 mt-1">v2.9-fix-hsdt</p>
          </footer>
        </div>
      </main>
