        ...
        <div className="px-4 pb-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-4 border border-amber-200 dark:border-amber-800">
              ...
              <p className="text-2xl font-bold text-amber-600">+{((metrics.satsPerShare - 380) / 380 * 100).toFixed(0)}%</p>
              <p className="text-xs text-amber-500">since Q3 2025 (380 → {Math.round(metrics.satsPerShare)} sats)</p>
            </div>
