...
export function MetaplanetCompanyView({ company, className = "" }: MetaplanetCompanyViewProps) {
  ...
  const metrics = useMemo(() => {
    ...
    const preferredEquity = 0; // Metaplanet has no preferred equity
        ...
        return (
          <details className="bg-gray-50 dark:bg-gray-900 rounded-lg mb-4 group" open>
            ...
            <div className="px-6 pb-6">
              ...
              {intel?.outlook2026 && (
                <div>
                  <h4 className="text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide mb-3">Outlook & Key Documents</h4>
