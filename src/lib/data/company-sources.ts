...
export const COMPANY_SOURCES: Record<string, CompanyDataSources> = {
  ...
  KULR: {
    ...
    secCik: "1662684",
    secFilingsUrl: "https://efts.sec.gov/LATEST/search-index?q=%221662684%22&forms=10-Q,10-K,8-K",
    exchange: "NYSE",
    sharesSource: "basic",
    sharesNotes: "1-for-8 reverse split June 23, 2025. sharesForMnav uses basic (45.67M); dilutives tracked separately.",
    reportsHoldingsFrequency: "on_purchase",
    reportsMnavDaily: true,
  ...
  LITS: {
    ...
    investorRelations: "https://www.litestrategy.com",
    secCik: "1262104",
    secFilingsUrl: "https://efts.sec.gov/LATEST/search-index?q=%221262104%22&forms=10-Q,10-K,8-K",
    exchange: "NASDAQ",
    sharesSource: "basic",
    sharesNotes: "Formerly MEI Pharma. Rebranded Sep 2025.",
    reportsHoldingsFrequency: "on_purchase",
    reportsMnavDaily: true,
    notes: "First US-listed LTC treasury. Charlie Lee on board. GSR as treasury manager. Covered call options program.",
