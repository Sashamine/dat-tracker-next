...
const H100ST_INTEL: CompanyIntel = {
  ...
  recentDevelopments: [
    ...
    "Future Holdings AG principals: Richard Byworth, Marc Syz, Donald Ewer (per MFN acquisition filing). Adam Back is H100 Group investor.",
  ],
