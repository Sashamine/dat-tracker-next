...
export const EARNINGS_DATA: EarningsRecord[] = [
  ...
  // Calendar year company (fiscal = calendar)
  // CIK: 0001889123
  // Data derived from holdings-history.ts SEC filing snapshots
  {
    ticker: "FLD",
    fiscalYear: 2024,
    fiscalQuarter: 3,
    ...
    earningsTime: null,
    holdingsAtQuarterEnd: 500,
    sharesAtQuarterEnd: 40_000_000,
    holdingsPerShare: 0.0000125,
    source: "sec-filing",
    sourceUrl: "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001889123&type=10-Q&count=40",
    status: "reported",
  },
  {
    ticker: "FLD",
    ...
    earningsDate: "2025-03-31",
    earningsTime: null,
    holdingsAtQuarterEnd: 800,
    sharesAtQuarterEnd: 42_000_000,
    holdingsPerShare: 0.0000190,
    source: "sec-filing",
    sourceUrl: "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001889123&type=10-K&count=40",
    status: "reported",
  },
  {
    ticker: "FLD",
    ...
    earningsDate: "2025-05-15",
    earningsTime: null,
    holdingsAtQuarterEnd: 1000,
    sharesAtQuarterEnd: 44_000_000,
    holdingsPerShare: 0.0000227,
    source: "sec-filing",
    sourceUrl: "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001889123&type=10-Q&count=40",
    status: "reported",
  },
  {
    ...
    earningsTime: null,
    holdingsAtQuarterEnd: 1200,
    sharesAtQuarterEnd: 46_000_000,
    holdingsPerShare: 0.0000261,
    source: "sec-filing",
    sourceUrl: "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001889123&type=10-Q&count=40",
    status: "reported",
  },
  {
    ...
    earningsDate: "2025-11-13",
    earningsTime: null,
    holdingsAtQuarterEnd: 1575,
    sharesAtQuarterEnd: 48_307_642,
    holdingsPerShare: 0.0000326,
    source: "sec-filing",
    sourceUrl: "https://www.sec.gov/Archives/edgar/data/1889123/000119312525274317/fld-20250930.htm",
    status: "reported",
  },
  ...
  // Q2 2025 - $2.5B raise closed May 29, but BTC purchases happened AFTER Q2 end
  // XBRL: ProfitLoss -$20M. Q2 10-Q has no crypto assets table — purchases in July 2025
  // Current assets jumped from $767M to $3.097B (cash from raise, not yet deployed)
  {
    ticker: "DJT",
    fiscalYear: 2025,
    fiscalQuarter: 2,
  ...
  // Q4 FY2025 (Oct-Dec 2025) - Reported Feb 16, 2026
  {
    ...
    calendarYear: 2025,
    calendarQuarter: 4,
    earningsDate: "2026-02-16",  // FY2025 results released Feb 16, 2026
    earningsTime: null,
