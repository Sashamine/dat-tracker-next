...
export const EARNINGS_DATA: EarningsRecord[] = [
  ...
  // Q2 2025
  {
    ...
    holdingsAtQuarterEnd: 226500,
    sharesAtQuarterEnd: 197_200_000,
    holdingsPerShare: 0.001149,
    source: "sec-filing",
    sourceUrl: "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001050446&type=10-Q",
    status: "reported",
  },
  // Q1 2025
  {
    ...
    holdingsAtQuarterEnd: 553555,
    sharesAtQuarterEnd: 257_300_000,
    holdingsPerShare: 0.002151,
    source: "sec-filing",
  ...
  // Q4 2024
  {
    ...
    holdingsAtQuarterEnd: 447470,
    sharesAtQuarterEnd: 245_000_000,
    holdingsPerShare: 0.001826,
    source: "sec-filing",
    sourceUrl: "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001050446&type=10-K",
    status: "reported",
  },
  ...
  // Q2 2024
  {
    ...
    netIncome: -102_600_000,
    holdingsAtQuarterEnd: 226500,
    sharesAtQuarterEnd: 168_000_000,
    holdingsPerShare: 0.001348,
    source: "sec-filing",
    sourceUrl: "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001050446&type=10-Q",
    status: "reported",
  },
  // Q1 2024
  {
    ...
    holdingsAtQuarterEnd: 214400,
    sharesAtQuarterEnd: 164_000_000,
    holdingsPerShare: 0.001307,
    source: "sec-filing",
    sourceUrl: "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001050446&type=10-Q",
    status: "reported",
  },
