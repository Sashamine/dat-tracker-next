...
export const MARKET_CAP_OVERRIDES: Record<string, number> = {
  ...
  // === BTC Treasury Companies without sharesForMnav ===
  "SWC": 171_000_000,         // ~$171M - Smarter Web Company (LSE UK), based on ~GBP 136M market cap from company analytics (Feb 2026)
  "NAKA": 1_500_000_000,      // $1.5B - Nakamoto Inc. (5K+ BTC, $210M Kraken loan) - no price feed

  // === SPACs and Pre-merger Companies (no reliable price feed) ===
  ...
  // Removed: MSTR, SBET, BMNR, DJT, ASST, TRON, AVX, FGNX, NA, LITS
  // — all have sharesForMnav, calculated market cap (shares × price) is more accurate
};
...
export const FALLBACK_STOCKS: Record<string, { price: number; marketCap: number }> = {
  ...
  "3189.T": { price: 245, marketCap: 64_800_000 },         // ANAP Holdings (JPY) - 40.61M shares × ¥245 ÷ 153.5 = $64.8M
  ...
  "SRAG.DU": { price: 1.74, marketCap: 190_000_000 },      // Samara Asset Group (EUR, Frankfurt) - 92.2M shares × €1.74 × 1.185 ≈ $190M
  ...
  // NDA.V, DMGI.V removed — companies dropped below threshold and removed from allCompanies
  ...
  "NA": { price: 2.95, marketCap: 70_000_000 },  // 23.6M shares × $2.95 (Mar 2026)
};
