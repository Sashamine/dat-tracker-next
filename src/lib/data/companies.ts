...
export const btcCompanies: Company[] = [
  ...
  },
  {
    ...
    holdingsSource: "sec-filing",
    holdingsSourceUrl: "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001554859&type=10-K",
    datStartDate: "2024-05-28",
    secCik: "0001554859",
    costBasisAvg: 68_000,
    isMiner: false,
    ...
    strategy: "Medical device company that adopted BTC treasury in May 2024. Reports BTC Yield.",
    notes: "Merged into Strive Asset (ASST) Jan 2026. Historical data preserved.",
  },
  {
    id: "kulr",
