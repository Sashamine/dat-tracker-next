...
export const btcCompanies: Company[] = [
  ...
  },
  {
    ...
    asset: "BTC",
    tier: 2,
    holdings: 2_414,  // ~$241M / $100K per BTC (SEC 10-Q Q3 2025)
    holdingsLastUpdated: "2025-09-30",
    holdingsSource: "sec-filing",
    holdingsSourceUrl: "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001839341&type=10-Q",
    datStartDate: "2024-01-01",
    secCik: "0001839341",
    isMiner: true,
    ...
    avgDailyVolume: 100_000_000,
    hasOptions: true,
    sharesForMnav: 310_061_300,  // SEC 10-Q Oct 2025
    leader: "Adam Sullivan (CEO)",
    strategy: "BTC miner pivoting to AI/HPC data centers. Maintains BTC treasury.",
    notes: "Emerged from bankruptcy Jan 2024. Now largest US data center operator. Also provides AI/HPC colocation.",
  },
  {
    id: "nxtt",
    ...
    asset: "BTC",
    tier: 2,
    holdings: 6_668,  // ~$667M / $100K per BTC (SEC 10-Q Q3 2025)
    holdingsLastUpdated: "2025-09-30",
    holdingsSource: "sec-filing",
    ...
    secCik: "0001784970",
    isMiner: true,
    quarterlyBurnUsd: 20_000_000,
    avgDailyVolume: 10_000_000,
    sharesForMnav: 456_265_135,  // SEC 10-Q Aug 2025 (pre any split)
    leader: "TBD",
    strategy: "BTC miner with significant treasury holdings.",
    notes: "Large BTC treasury relative to market cap. Verify share count - may have had reverse split.",
  },
  {
    id: "btdr",
    ...
    asset: "BTC",
    tier: 2,
    holdings: 3_000,  // Estimated from mining production (~636 BTC/month Dec 2025)
    holdingsLastUpdated: "2025-12-31",
    holdingsSource: "sec-filing",
    holdingsSourceUrl: "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001899123&type=6-K",
    datStartDate: "2024-01-01",
    secCik: "0001899123",
    isMiner: true,
    btcMinedAnnual: 7_600,  // ~636 BTC/month × 12
    quarterlyBurnUsd: 30_000_000,
    avgDailyVolume: 50_000_000,
    hasOptions: true,
    sharesForMnav: 200_000_000,  // Estimated - verify from 20-F
    leader: "Jihan Wu (CEO)",
    strategy: "Singapore-based miner. 55.2 EH/s hashrate. SEALMINER manufacturing.",
    notes: "Foreign filer (IFRS). Manufactures own mining rigs. Holdings need verification from 20-F annual.",
  },
  {
    id: "asst",
