...
export const btcCompanies: Company[] = [
  ...
  // HUT (Hut 8) removed - pivoted to AI/HPC infrastructure, not a DAT company
  {
    ...
    avgDailyVolume: 30_000_000,
    hasOptions: true,
    sharesForMnav: 974_910_000,  // Derived: 5,401 BTC × 100M / 554 SPS = ~975M (FY2025 earnings 8-K Feb 26, 2026)
    sharesSource: "FY2025 earnings 8-K: SPS=554 sats as of Dec 31, 2025 implies ~975M shares (Q4 ATM raised $150.5M)",
    sharesSourceQuote: "Increased Satoshis per share by 49%, from 371 as of September 30, 2025 to 554 as of December 31, 2025",
    sharesSourceUrl: "https://www.sec.gov/Archives/edgar/data/1755953/000119312526073305/abtc-ex99_1.htm",
    sharesAsOf: "2025-12-31",
...
export const suiCompanies: Company[] = [
  {
    ...
    secCik: "0001425355",
    cashReserves: 21_936_274,
    cashAsOf: "2025-12-31",
    cashSource: "SEC 10-K FY2025 (filed Feb 27, 2026)",
    cashSourceQuote: "CashCashEquivalentsRestrictedCashAndRestrictedCashEquivalents: $21,936,274 (XBRL Dec 31, 2025)",
    cashSourceUrl: "/filings/suig/0001654954-26-001672",
    totalDebt: 277_778,
    debtSource: "SEC 10-K FY2025 XBRL: OtherNotesPayable $277,778",
    debtAsOf: "2025-12-31",
    ...
    stakingSource: "SEC 10-K FY2025: 'significant majority...staked...yield of approximately 1.7%'. Updated from prior 2.2% estimate.",
    ...
    sharesForMnav: 80_896_554,  // SEC 10-K FY2025 MD&A: "80,896,554 fully adjusted shares issued and outstanding (including unexercised Pre-Funded Warrants) as of February 23, 2026"
    sharesAsOf: "2026-02-23",
    sharesSource: "SEC 10-K FY2025 (filed Feb 27, 2026) MD&A",
    sharesSourceQuote: "80,896,554 fully adjusted shares issued and outstanding (including unexercised Pre-Funded Warrants) as of February 23, 2026",
    sharesSourceUrl: "/filings/suig/0001654954-26-001672",
    leader: "Douglas Polinsky (CEO)",
    strategy: "Only public company with Sui Foundation relationship",
    notes: "108.4M SUI (Feb 23). FY2025 10-K: $265M net loss (unrealized SUI mark-to-market). 1.34 SUI/share. $21.9M cash. 8.1M shares bought back in FY2025 ($18.9M, $50M program ~$33M remaining). Authorized shares increased to 2B. ~1.7% staking yield.",
