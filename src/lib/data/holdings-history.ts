...
const UPXI_HISTORY: HoldingsSnapshot[] = [
  { date: "2025-04-15", holdings: 596714, sharesOutstandingDiluted: 22_000_000, holdingsPerShare: 0.02712, totalDebt: 100_000_000, cash: 20_000_000, source: "Initial $100M SOL purchase", sourceType: "press-release", sourceUrl: "https://ir.upexi.com/news-events/press-releases" },
  { date: "2025-06-30", holdings: 744_026, sharesOutstandingDiluted: 38_270_571, holdingsPerShare: 0.01944, totalDebt: 150_000_000, cash: 30_000_000, source: "FY2025 10-K", sourceType: "sec-filing", sourceUrl: "https://www.sec.gov/Archives/edgar/data/1775194/000147793225006996/upxi_10k.htm" },
  { date: "2025-07-31", holdings: 1900000, sharesOutstandingDiluted: 40_000_000, holdingsPerShare: 0.04750, totalDebt: 186_000_000, cash: 40_000_000, source: "Press release", sourceType: "press-release", sourceUrl: "https://ir.upexi.com/news-events/press-releases" },
  { date: "2025-08-05", holdings: 2000518, sharesOutstandingDiluted: 45_000_000, holdingsPerShare: 0.04446, totalDebt: 200_000_000, cash: 45_000_000, source: "2M SOL milestone", sourceType: "press-release", sourceUrl: "https://ir.upexi.com/news-events/press-releases" },
  { date: "2025-09-30", holdings: 2_066_827, sharesOutstandingDiluted: 58_888_756, holdingsPerShare: 0.03509, totalDebt: 200_000_000, cash: 50_000_000, source: "Q1 FY2026 10-Q Note 5: 2,066,827 SOL", sourceType: "sec-filing", sourceUrl: "https://www.sec.gov/Archives/edgar/data/1775194/000147793225008025/upxi_10q.htm" },
...
const FUFU_HISTORY: HoldingsSnapshot[] = [
  ...
  { date: "2024-09-30", holdings: 1000, sharesOutstandingDiluted: 158_000_000, holdingsPerShare: 0.0000063, stockPrice: 4.04, totalDebt: 95_000_000, cash: 30_000_000, source: "Q3 2024 6-K", sourceType: "sec-filing", sourceUrl: "https://efts.sec.gov/LATEST/search-index?q=%22bitfufu%22&forms=6-K&dateRange=custom&startdt=2024-07-01&enddt=2024-12-31" },
...
const SWC_HISTORY: HoldingsSnapshot[] = [
  ...
  { date: "2026-01-22", holdings: 2674, sharesOutstandingDiluted: 395_188_479, holdingsPerShare: 0.00000677, source: "RNS Bitcoin Purchase + company analytics", sourceUrl: "https://www.smarterwebcompany.co.uk/bitcoin-treasury/analytics-/", sourceType: "regulatory-filing" },  // Original PDF URL 404'd (Wix site reorganized)
  { date: "2026-02-11", holdings: 2_689, sharesOutstandingDiluted: 396_602_526, holdingsPerShare: 0.00000678, source: "RNS Bitcoin Purchase + company analytics", sourceUrl: "https://www.smarterwebcompany.co.uk/bitcoin-treasury/analytics-/", sourceType: "regulatory-filing" },  // Original PDF URL 404'd (Wix site reorganized)
];
